...
SELECT PHONENUMBER, COUNT(1) AS TENTATIVAS INTO #TENTATIVAS FROM TENTATIVAS_2
WHERE CAMPAIGNID IN (126,176) AND CALLSTART BETWEEN '2020-01-06' AND '2020-06-30'
GROUP BY PHONENUMBER


SELECT DISTINCT PHONENUMBER INTO #DISCADO FROM TENTATIVAS_2
WHERE CALLSTART BETWEEN '2020-01-01' AND '2020-06-30'

SELECT DISTINCT CUSTOMERID, PHONENUMBER INTO #ALO FROM TENTATIVAS_2
WHERE STATUS_DESCRIPTION LIKE 'Transf%'
AND CALLSTART BETWEEN '2020-01-01' AND '2020-06-30'

SELECT DISTINCT CUSTOMERID INTO #TRANSFERIDO FROM TENTATIVAS_AQUISICAO
WHERE CAMPAIGNID IN (127)
AND CALLSTART BETWEEN '2020-01-01' AND '2020-06-30'

SELECT DISTINCT CUSTOMERID INTO #AGENDAMENTO FROM TENTATIVAS_AQUISICAO
